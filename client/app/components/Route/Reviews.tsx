    ...
    <div className="w-[90%] 800px:w-[85%] m-auto">
      <div className="w-full 800px:flex items-center">
        ...
        <div className="800px:w-[50%] w-full">
          ...
          <p className={styles.label}>
            We are committed to providing top-notch education and support to help our students achieve their goals. Our community of learners spans across the globe, and their success stories are a testament to the quality and impact of our courses. From career advancements to personal growth, hear directly from our students about how our courses have made a difference in their lives.
          </p>
        </div>
        <br />
        <br />
      ...
      <div className="mt-5 mb-[100px]" >
        ...
        <div className="flex items-center justify-center mt-5 space-x-2">
          ...
          <h2 className="text-white text-xl font-semibold">Let's have a look at our students reaction!</h2>
        </div>
      </div>
